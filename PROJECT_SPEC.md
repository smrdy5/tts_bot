...
You are an expert AI developer. Your task is to build a production-ready Telegram Bot architecture from scratch. This project connects a Django webhook backend (hosted on Render) to a Serverless GPU inference engine (hosted on Modal) running VoxCPM2 for Text-to-Speech and Voice Cloning.

## TECH STACK
* **AI GPU Engine:** Modal, Python, FastAPI, VoxCPM2, PyTorch
